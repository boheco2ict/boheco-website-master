...
const Navigation = () => {
  ...
  return (
    <>
          ...
          <nav className="flex h-full w-full flex-col">
            ...
            <div className="flex items-center gap-3 px-3 py-5 border-b border-slate-200">
              ...
              >
                ...
                <p className="mt-0.5 text-[9px] font-semibold uppercase tracking-wider theme-muted whitespace-nowrap">
                  Services
                </p>
              </div>
            </div>
                ...
                return (
                  <>
                    {nonLogout.map((link) => {
                      ...
                      const isCOOPActive =
                        link.link === "coop-policies" &&
                        location.pathname === "/coop-policies";
      ...
      <header
        className={`fixed left-0 top-0 z-50 w-full shadow-none xl:shadow-md backdrop-blur-sm app-header ${
          auth ? "xl:hidden" : ""
        }`}
        style={{
      ...
      >
        <div className="mx-auto flex min-h-[64px] max-w-[1440px] items-center justify-between px-4 sm:px-6 lg:px-8">
          {auth ? (
            <div
              className="flex min-w-0 items-center gap-3 rounded-md py-1 pr-2"
            ...
            >
              <img
                src={img[0]}
                alt="BOHECO II logo"
                className="h-10 w-10 flex-none bg-transparent shadow-sm rounded-md"
              />
            ...
            <NavLink
              to="/"
              className="group flex min-w-0 items-center gap-3 rounded-lg py-1 pr-2 transition-all hover:bg-amber-50/70"
              aria-label="BOHECO II home"
              style={{ color: "var(--text-primary)" }}
            >
              <img
              ...
              />
              <div className="border-l-4 border-amber-400 pl-3 leading-tight">
                <p className="text-base font-extrabold tracking-wide group-hover:text-amber-800 transition-colors">
                  BOHECO II
                </p>
                <p
                  className="mt-0.5 text-[10px] font-semibold uppercase tracking-widest"
        ...
        <nav
          className={`${
            open
              ? "translate-y-0 opacity-100 mobile-nav-slide"
              : "pointer-events-none -translate-y-2 opacity-0 hidden"
          } absolute left-0 top-full w-full px-4 py-3 shadow-lg transition-all duration-300 max-h-[calc(100vh-64px)] overflow-y-auto`}
                  ...
                  >
                    {({ isActive }) => {
                      ...
                      return (
                        <>
                          <span
                            className={`flex items-center justify-center w-10 h-10 flex-none rounded-md transition-all ${
                              isActive
