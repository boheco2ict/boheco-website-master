const Header = () => {
  ...
  return (
    <header className="fixed left-0 top-0 z-50 h-[76px] w-full border-b border-slate-200 bg-[#FFFBEB] shadow-sm">
      <div className="flex h-full items-center justify-between px-5 sm:px-6">
        {/* BRAND */}
        <div className="flex shrink-0 items-center">
          {/* Logo */}
          <div className="flex h-12 w-12 items-center justify-center">
            <img src={img} alt="BOHECO II" className="h-12 w-12 object-contain" />
          </div>
          {/* Divider */}
